...
@Config
@Autonomous(name="Blue Close Auto From Gate 15", group="Robot")
@SuppressWarnings("FieldCanBeLocal")
public class leftCloseAutoGate15 extends LinearOpMode {
...
//    public static double INTAKE_HUMAN_PLAYER_FLICKER_TIME = 3;
    ...
    private final Pose startPose = new Pose(129, 116+AUTO_Y_OFFSET, Math.toRadians(180)).mirror(); // Start Pose of our robot
