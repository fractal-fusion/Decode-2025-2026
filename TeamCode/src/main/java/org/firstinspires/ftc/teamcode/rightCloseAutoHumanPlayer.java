...
@Config
@Autonomous(name="Red Close Auto From Close HP", group="Robot")
@SuppressWarnings("FieldCanBeLocal")
public class rightCloseAutoHumanPlayer extends LinearOpMode {
...
//                            turnOffShooterAuto(); commented out to reduce power draw from turning shooter off and on
            ...
            case 3: //move to score position for top row
                if (!follower.isBusy()) {
                    ...
                    shooter.initializeBurstClose(); //prestart shooter
                    shooter.turnOnShooterAuto();
                    setPathState(4);
                }
                break;
