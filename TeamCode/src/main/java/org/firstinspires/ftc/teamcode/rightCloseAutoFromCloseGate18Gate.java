...
public class rightCloseAutoFromCloseGate18Gate extends LinearOpMode {
...
//                            turnOnShooterAuto();
                ...
                break;
            case 13: //third collect balls from gate
                if (!follower.isBusy()){
                    if (init){
                        intake.turnOnIntakeAuto();
                        init = false;
...
//                        intake.turnOffIntake();
                ...
                break;
            case 16: //third shoot collected balls
                if (!follower.isBusy()) {
                    if(init){
                        shooter.ballsShot = 9;
//                            intializeBurstClose();
