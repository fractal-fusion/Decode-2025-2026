...
@Config
@Autonomous(name="Red Close Auto From Gate", group="Robot")
@SuppressWarnings("FieldCanBeLocal")
public class rightCloseAutoFromCloseGate15 extends LinearOpMode {
...
//                            turnOnShooterAuto();
                ...
                break;
            case 12: //collect balls from gate
                if (!follower.isBusy()){
                    if (init){
                        intake.turnOnIntakeAuto();
                        init = false;
                ...
                break;
            case 13: //collect all balls from gate
                if (!follower.isBusy()){
//                    follower.followPath(moveBackCollectBalls, 0.4, false);
                ...
                break;
            case 14: //move to score position for collected balls
                if (!follower.isBusy()) {
                    if (init){
//                        intake.turnOffIntake();
                        initializeBurstClose(); //prestart shooter
