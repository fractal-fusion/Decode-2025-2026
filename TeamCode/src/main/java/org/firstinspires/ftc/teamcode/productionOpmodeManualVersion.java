...
@TeleOp(name="productionOpmodeManualVersion", group="Robot")
public class productionOpmodeManualVersion extends LinearOpMode {
...
//        camera.setGain(250);
        ...
        while (opModeIsActive())
        {
            ...
            if (gamepad1.right_bumper){
                ...
                drivetrain.driveAutoAlign(gamepad1, drivetrain.calculateSecondaryPIDAutoAlignPowerOdo(-drivetrain.calculateOdoGoalBearing(follower.getPose(), PoseManager.currentGoalPose)));
                drivetrain.holdPose = follower.getPose();
            }
            else if (gamepad1.b){
...
//            }
            ...
            shooter.testControlRampPosition(gamepad2);
            shooter.testShoot(gamepad2);

            shooter.setTargetRPMToleranceRPM(4000);
...
//            telemetry.addData("shooter at velocity time:", shooter.atVelocityTime);
            ...
            telemetry.addData("last regression value:", shooter.lastRegressionValue);            telemetry.addLine("------------------------------------------------------");
