...
//    public Servo shooterPitchLeft;
    ...
    public static double FAR_AUTO_TARGET_RPM = 3770;
    ...
    public static double CLOSE_RAMP_EDGE_SCORE_POSITION = 0.08;
    ...
    public static double CLOSE_AUTO_TARGET_RPM_EDGE = 3000;
...
//        shooterPitchRight.setDirection(Servo.Direction.REVERSE);
    ...
    public void turnOffShooterRestingRpm(){
        shooterRight.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        shooterLeft.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
