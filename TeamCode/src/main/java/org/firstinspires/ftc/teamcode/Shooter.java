...
public class Shooter{
    ...
    public static double CLOSE_AUTO_TARGET_RPM = 3100;
    public static double CLOSE_AUTO_TARGET_RPM_PRELOAD = CLOSE_AUTO_TARGET_RPM - 50;
    public static double CLOSE_AUTO_TARGET_RPM_EDGE = 3200;
